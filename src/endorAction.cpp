...
endorActionClass::endorActionClass(int nodeActionList_width1=9,int Number_of_Nodes1=10,int Number_of_Arms1=3,int Number_of_Actions1=26):nodeActionList_width(nodeActionList_width1),Number_of_Nodes(Number_of_Nodes1),Number_of_Arms_State(Number_of_Arms1),Number_of_Actions(Number_of_Actions1){
	...
	for (int i1=0;i1<Number_of_Actions;i1++)
		action_list[i1]=new string [Number_of_Arms_State+2];// first column: action name, 2nd: resposible, other columns, each arm command.
...
//	action_list[25][0]	="StopRobot";						action_list[25][1]	="R";	action_list[25][2]	="stop 0";														action_list[25][3]	="stop 1";
	action_list[0][0]	="PickUp";						action_list[0][1]	="H";	action_list[0][2]	="PickUp";									action_list[0][3]	="0"; 							action_list[0][4]	="0";
	action_list[1][0]	="Screwing";					action_list[1][1]	="H";	action_list[1][2]	="Screwing";								action_list[1][3]	="0"; 							action_list[1][4]	="0";
	action_list[2][0]	="PutDown";						action_list[2][1]	="H";	action_list[2][2]	="PutDown";									action_list[2][3]	="0"; 							action_list[2][4]	="0";
	action_list[3][0]	="GraspLeft";					action_list[3][1]	="R";	action_list[3][2]	="grasp left";								action_list[3][3]	="0"; 							action_list[3][4]	="0";
	action_list[4][0]	="GraspRight";					action_list[4][1]	="R";	action_list[4][2]	="0";										action_list[4][3]	="grasp right"; 				action_list[4][4]	="0";
	action_list[5][0]	="UnGraspLeft";					action_list[5][1]	="R";	action_list[5][2]	="unGrasp left";							action_list[5][3]	="0"; 							action_list[5][4]	="0";
	action_list[6][0]	="UnGraspRight";				action_list[6][1]	="R";	action_list[6][2]	="0";										action_list[6][3]	="unGrasp right"; 				action_list[6][4]	="0";
	action_list[7][0]	="HandOverLeftPoint8";			action_list[7][1]	="R";	action_list[7][2]	="pointReach left 8";						action_list[7][3]	="0"; 							action_list[7][4]	="0";
	action_list[8][0]	="HoldOnRight";					action_list[8][1]	="R";	action_list[8][2]	="0";										action_list[8][3]	="holdOn right"; 				action_list[8][4]	="0";
	action_list[9][0]	="StopLeft";					action_list[9][1]	="R";	action_list[9][2]	="stop left";								action_list[9][3]	="0"; 							action_list[9][4]	="0";
	action_list[10][0]	="StopRight";					action_list[10][1]	="R";	action_list[10][2]	="0";										action_list[10][3]	="stop right"; 					action_list[10][4]	="0";
	action_list[11][0]	="HandOverRightPoint1";			action_list[11][1]	="R";	action_list[11][2]	="0";										action_list[11][3]	="pointReach right 0"; 			action_list[11][4]	="0";
	action_list[12][0]	="HandOverRightPoint2";			action_list[12][1]	="R";	action_list[12][2]	="0";										action_list[12][3]	="pointReach right 1"; 			action_list[12][4]	="0";
	action_list[13][0]	="HandOverRightPoint3";			action_list[13][1]	="R";	action_list[13][2]	="0";										action_list[13][3]	="pointReach right 2"; 			action_list[13][4]	="0";
	action_list[14][0]	="HandOverPoint4";				action_list[14][1]	="R";	action_list[14][2]	="pointReach left 3";						action_list[14][3]	="pointReach right 4"; 			action_list[14][4]	="0";
	action_list[15][0]	="HandOverLeftPoint5";			action_list[15][1]	="R";	action_list[15][2]	="pointReach left 5";						action_list[15][3]	="0"; 							action_list[15][4]	="0";
	action_list[16][0]	="HandOverRightPoint6";			action_list[16][1]	="R";	action_list[16][2]	="0";										action_list[16][3]	="pointReach right 6"; 			action_list[16][4]	="0";
	action_list[17][0]	="PickUp_2_Plate_Init_Pos";		action_list[17][1]	="H";	action_list[17][2]	="PickUp Screw To plate Initial Position";	action_list[17][3]	="0"; 							action_list[17][4]	="0";
	action_list[18][0]	="ScrewingInitial";				action_list[18][1]	="H";	action_list[18][2]	="ScrewingInitial";							action_list[18][3]	="0"; 							action_list[18][4]	="0";
	action_list[19][0]	="PutDown_hand_2_Resting";		action_list[19][1]	="H";	action_list[19][2]	="Put Down Your Hand In Resting Position";	action_list[19][3]	="0"; 							action_list[19][4]	="0";
	action_list[20][0]	="HandOver2InitialPos";			action_list[20][1]	="R";	action_list[20][2]	="pointReach left 10";						action_list[20][3]	="pointReach right 9"; 			action_list[20][4]	="0";
	action_list[21][0]	="HandOverLeftPoint7";			action_list[21][1]	="R";	action_list[21][2]	="pointReach left 7";						action_list[21][3]	="0"; 							action_list[21][4]	="0";
	action_list[22][0]	="Grasp";						action_list[22][1]	="R";	action_list[22][2]	="grasp left"; 								action_list[22][3]	="grasp right"; 				action_list[22][4]	="0";
	action_list[23][0]	="UnGrasp";						action_list[23][1]	="R";	action_list[23][2]	="unGrasp left"; 							action_list[23][3]	="unGrasp right"; 				action_list[23][4]	="0";
	...
	// check for the action in action list and who should do that:
		for(int i=0;i<Number_of_Actions;i++)
			if (action_list[i][0]==suggested_action)
			{
				...
				actionCommand[j]=action_list[i][2+j];
...
void endorActionClass::robStopFunction(){
	...
	for (int j=0;j<Number_of_Arms_State;j++){
	actionCommand[j]=action_list[25][2+j];
}
