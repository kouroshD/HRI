...
endorActionClass::endorActionClass(int nodeActionList_width1=9,int Number_of_Nodes1=10,int Number_of_Arms1=2,int Number_of_Actions1=26):nodeActionList_width(nodeActionList_width1),Number_of_Nodes(Number_of_Nodes1),Number_of_Arms(Number_of_Arms1),Number_of_Actions(Number_of_Actions1){
	...
	node_action_list[7][0]="0";					node_action_list[7][1]="0";						node_action_list[7][2]="0";							node_action_list[7][3]="0";						node_action_list[7][4]="0";							node_action_list[7][5]="0";						node_action_list[7][6]="0";					node_action_list[7][7]="0";						node_action_list[7][8]="0";
	...
	action_list[15][0]	="HandOverLeftPoint5";			action_list[15][1]	="R";	action_list[15][2]	="jointPos left -0.611 0 0 0 -1.571 1.658 -1.571";				action_list[15][3]	="0";
