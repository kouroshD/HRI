...
///	printGraphInfo();
    ...
    string init_suggestion;
    init_suggestion=suggestNext(true);
    return init_suggestion;
}
...
string AOgraph::loadFromFile(string fileName)
{
...
bool AOgraph::NodeFeasibiltyInfo(int i)
{
        return graph[i].printNodeFeasibiltyInfo();
}
bool AOgraph::NodeSolveInfo(int i)
{
        return graph[i].printNodeSolveInfo();
}
string AOgraph::NodeNameInfo(int i)
{
        return graph[i].printNodeNameInfo();
}
