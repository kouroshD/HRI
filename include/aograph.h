...
//class AOgraph;
//void endorActionClass::humanActionSearch(string, AOgraph&);
...
{    
    ...
    public:
        ...
        void printGraphInfo();
        bool NodeFeasibiltyInfo(int);
        bool NodeSolveInfo(int);
        string NodeNameInfo(int);
        ...
        //friend void endorActionClass::humanActionSearch(string, AOgraph&);
        friend class endorActionClass;
        // define friend Class
